...
- **Permissionless, independent verification**: anyone can run a full node and recompute the
  entire state from the blockchain (see [Security Model](./security-model.md)).
...
[Security Model → Obfuscation Is Not Encryption](./security-model.md)). XChain is not a privacy
...
[Smart Contracts](./smart-contracts.md)). A contract **can** invoke another contract, on the same
...
DOGE-anchored checkpoint (see [Block Hashes](./block-hashes.md)). This is a federated trust
...
[NFT Standard](../protocol/nft-standard.md), composed from existing primitives: a supply-1,
...
[Token Information Standard](../protocol/token-information-standard.md). This keeps the consensus
...
the [Token Information Standard](../protocol/token-information-standard.md). That content's
...
*See also: [Metalayer](./metalayer.md) | [Security Model](./security-model.md) | [Smart Contracts](./smart-contracts.md) | [Cross-Chain](./cross-chain.md)*
