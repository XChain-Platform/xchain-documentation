...
Token metadata (images, descriptions, links, audio, video) is stored off-chain and referenced by a URI in the token's description field. The [Token Information Standard](../protocol/token-information-standard.md) defines the expected JSON schema for that metadata document, including fields for name, description, image, and various media types.
...
*See also: [Ledger](./ledger.md) | [Gas](./gas.md) | [ISSUE spec](../protocol/actions/issue.md) | [Token Information Standard](../protocol/token-information-standard.md)*
