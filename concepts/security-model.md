...
| Configuration trustworthiness | Hub validator network (PBFT consensus, stake-weighted quorum agreement at/above `STAKE_WEIGHTED_QUORUM_ACTIVATION`, legacy `max(2f+1, ceil((N+1)/2))` count below it) |
