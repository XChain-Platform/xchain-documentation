 ...
 * below have to see past comments. The per-line `replace(/\/\/.*$/, '')` they
 * used to do is not that: it cuts at the first `//` WHEREVER it sits, so
 ...
 * inside one used to scan as live configuration.
 *
