...
The AGPL asks one main thing in return: **if you modify XChain and run it as a service for others over a network, you must make your modified source code available to those users** under the AGPL. Share-alike. You also keep the attribution and the [NOTICE](../NOTICE.md) file.
...
*This page is a plain-language summary for convenience. The binding documents are the [AGPL-3.0 LICENSE](../LICENSE.md) and any signed commercial agreement; if anything here conflicts with them, they control.*
