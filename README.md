...
| [**Protocol Spec**](./protocol/) | 34 ACTION definitions, Token Information Standard, schemas | Protocol devs |
...
| [**xchain-sdk**](https://github.com/XChain-Platform/xchain-sdk/) | Developer SDK: 29 action methods, 48 explorer queries, smart contract support, real-time WebSocket events, batch builder, PSBT generation |
