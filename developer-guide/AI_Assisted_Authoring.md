...
[Solidity to XChain](./Solidity_To_XChain.md) for why, and for the concept map the
...
[Solidity to XChain](./Solidity_To_XChain.md), then holds the output to the gate.
...
- [Solidity to XChain](./Solidity_To_XChain.md) - the concept map, native-action
  shortcuts, and side-by-side examples the AI workflow is built on.
- [Smart Contract Development](./Smart_Contract_Development.md) - the full
  authoring, linting, and deployment guide.
- [Regtest Development](./Regtest_Development.md) - run a local stack to exercise
