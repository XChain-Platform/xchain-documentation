...
`xchain-indexer/src/configs/BTC.js`, `xchain-decoder/src/chain/crypto_networks.js`) that reads
...
- [XChain Genesis](../operations/xchain-genesis.md): the genesis ledger pin mechanism this generalizes
