...
| `gateway_emit.js` | Emit API builder: 19 action types (SEND through MESSAGE and VOTE, plus `execute` for cross-contract calls and `crossExecute` for cross-chain calls), parameter validation, gas charging |
