...
| Desktop: Mac App Store | [desktop/mac-app-store.md](desktop/mac-app-store.md) | Planned, pending store enrollment |
| Desktop: Microsoft Store | [desktop/microsoft-store.md](desktop/microsoft-store.md) | Planned, pending store enrollment |
