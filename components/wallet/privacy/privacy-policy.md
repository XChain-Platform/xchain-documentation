...
<!-- ported 2026-08-02 from xchain-wallet/docs/Privacy_Policy.md @ 34639117 (worktree dirty) -->
...
**Single purpose.** The single purpose of the extension is to let you hold and move XChain Platform coins (Bitcoin, Dogecoin, Litecoin, and their XChain-issued tokens) self-custodially from within the browser, and to sign XChain actions on behalf of sites you connect to.
...
- In the browser extension, avoid the transaction detail view if you would rather not load block-explorer icons, since that one has no setting. On every other shell the icons are never loaded in the first place.
...
Questions or complaints about privacy: email privacy@dankest.llc, or open an issue on the [XChain Wallet GitHub repository](https://github.com/XChain-Platform/xchain-wallet/issues).

Security issues have their own channel: see the `SECURITY.md` file in the source repository. Please report those there rather than here.

## Related documents

- [Data collection](https://docs.xchain.io/components/wallet/privacy/data-collection), the technical detail behind this policy
- [Trader identity](https://docs.xchain.io/components/wallet/privacy/trader-identity), the published business contact for regulatory declarations
- [Export compliance](https://docs.xchain.io/components/wallet/privacy/export-compliance), the encryption used in the wallet
