...
- **Protocol versioning**: actions are gated by the indexer's own protocol version (21 at `1.0.0`, 15 at `2.0.0`, all with zero activation heights); block-height and timestamp flag-days gate behaviour changes to already-live actions, per network
