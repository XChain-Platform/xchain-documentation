...
The full registry is documented at [Error Codes](../../protocol/Error_Codes.md).
...
See [Format Selection](Format_Selection.md) for the full size limits and auto-selection logic.
...
- [Format Selection](Format_Selection.md): decision guide and size limits for each encoding format
- [API Reference (all services)](../../developer-guide/API_Reference.md): the platform-wide REST and JSON-RPC entry point
