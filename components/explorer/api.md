...
OpenAPI 3.1 specification for all explorer REST endpoints. Regenerated by `docs/openapi.build.js`; kept in sync with the route tables by `test/unit/openapi_coverage.test.js`.
