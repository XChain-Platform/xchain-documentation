...
The platform roadmap includes agent wallet sessions with spending limits, an HTTP 402-style flow for paying for data and API calls with XChain tokens, and paid attestations. Watch this section.
