...
contract-era timestamp (`1786060800`), so it belongs with **Cohort A**; it is registered as a
...
the single 2026-08-07 contract-era timestamp (`1786060800`): it is deliberately armed one quarter later,
