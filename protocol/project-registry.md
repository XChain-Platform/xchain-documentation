...
[NFT Standard](./nft-standard.md), it is a **composition of existing primitives, not a
...
- **Display metadata**: the project's branding, description, and website travel in
  its [Token Information Standard](./token-information-standard.md) document, like
  any token.
...
- Files linked to the project's `ISSUE` (logos, documentation) are unaffected, this
  ...
  [content-attachment meaning](./nft-standard.md#attaching-content).
...
parent/child issuance is already consensus-enforced membership
  ([NFT Standard; Collections](./nft-standard.md#collections)). Registries are for
...
- ✅ For high-value purchases: the project's TIS pointer hygiene
  ...
  [NFT Standard](./nft-standard.md#display-metadata)
