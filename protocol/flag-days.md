...
One gate does not ride it and carries a date of its own: `CROSS_CHAIN_ROYALTY` at 2027-01-01 00:00:00 UTC. The reason each is armed separately is on [Protocol Activation](./protocol-activation.md#additional-armed-gates-service-carried).
