...
| [Platform Map (interactive)](./platform-map.md) | Zoomable diagram of every service and link, with selectable end-to-end flows (action write path, XCALL, attestation, replication, anchoring) |
