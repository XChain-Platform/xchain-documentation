...
const SCOPED = [
  { file: 'components/e2e-test/README.md', claim: '30 ACTION', count: 1,
    why: 'test suites counted one per ACTION name with versions folded in, not the ACTION set; '
       + 'the bullet enumerates all 30 and states the rule, and '
  ...
  { file: 'components/e2e-test/architecture.md', claim: '30 ACTION names', count: 1,
    why: 'ACTION names those 76 files cover, one entry per name with versions folded in; '
