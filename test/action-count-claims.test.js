...
const SCOPED = [
  { file: 'components/e2e-test/architecture.md', claim: '80 action', count: 1,
    why: 'test files, several per action; git ls-files xchain-e2e-test/test/actions on 2026-09-07. '
