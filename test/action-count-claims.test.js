...
const SCOPED = [
  { file: 'components/e2e-test/architecture.md', claim: '71 action', count: 1,
    why: 'test files, several per action; ls xchain-e2e-test/test/actions/*.test.js on 2026-08-13 '
       + 'after the batch acceptance suites landed' },
