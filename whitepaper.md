...
- **UNSTAKE** begins cooldown: v0 capability, v1 contract-targeted. Both accept an optional trailing amount for a partial unstake, with the residual re-staked seamlessly; absent, the historical full sweep. *(partial forms: pre-launch, mainnet flag-day 2026-08-07; live on testnet/regtest.)*
