...
- **UNSTAKE** begins cooldown: v0 capability, v1 contract-targeted. Both accept an optional trailing amount for a partial unstake, with the residual re-staked seamlessly; absent, the historical full sweep. *(partial forms: pre-launch, [mainnet contract-era flag day](./protocol/flag-days.md#contract-era-flag-day); live on testnet/regtest.)*
